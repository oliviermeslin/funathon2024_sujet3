...
Pour calculer un cap à partir de positions différentes à $t$ et $t-1$ en degrés, on pourra suivre les étapes suivantes:

- Conversion des coordonnées en radians:
$$
\text{lat}_1 \rightarrow \phi_1 = \text{lat}_1 \times \frac{\pi}{180}
$$

$$
\text{lon}_1 \rightarrow \lambda_1 = \text{lon}_1 \times \frac{\pi}{180}
$$

$$
\text{lat}_2 \rightarrow \phi_2 = \text{lat}_2 \times \frac{\pi}{180}
$$

$$
\text{lon}_2 \rightarrow \lambda_2 = \text{lon}_2 \times \frac{\pi}{180}
$$

- Calcul du cap: utiliser les formules suivantes pour calculer le cap \theta (en radians):
...
$$
\theta_{\text{degrés}} = \theta \times \frac{180}{\pi}
$$

- Normalisation de l'angle pour qu'il soit compris entre 0 et 360 degrés:

$$
\theta_{\text{degrés}} = (\theta_{\text{degrés}} + 360) \mod 360
$$
</details>
